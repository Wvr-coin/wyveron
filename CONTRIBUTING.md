Contributing to wvr Coin
============================

The wvr Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/wvr/wvr/blob/master/doc/translation_process.md)
...
The following applies to code changes to the wvr Coin project, and is not to be
confused with overall wvr Network Protocol consensus changes.

Whether a pull request is merged into wvr Coin rests with the project merge
...
Patches that change wvr consensus rules are considerably more involved than
...
Where a patchset proposes to change the wvr consensus, it must have been
...
The project leader is the release manager for each wvr Coin release.
