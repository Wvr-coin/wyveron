...
from test_framework.wvr_node import wvrTestNode
...
class wvr_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(wvrTestNode())
