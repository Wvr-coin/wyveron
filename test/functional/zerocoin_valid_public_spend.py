...
class zwvrValidCoinSpendTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zwvrs..." % DENOM_TO_USE)
        for i in range(5):
        ...
        assert_raises_rpc_error(-26, "bad-txns-invalid-zwvr",
