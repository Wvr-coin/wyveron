...
wvr.conf           | contains configuration settings for wvrd or wvr-qt
wvrd.pid           | stores the process id of wvrd while running
...
debug.log           | contains debug information and general logging generated by wvrd or wvr-qt
