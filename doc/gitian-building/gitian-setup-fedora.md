...
The build script we'll be using is contained in the wvr github repository ([contrib/gitian-build.py](https://github.com/wvr/wvr/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the wvr repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/wvr/wvr/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, wvr-detached-sigs, and wvr GitHub repos.
