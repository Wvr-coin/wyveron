...
RESOURCES += src/qt/wvr.qrc src/qt/wvr_locale.qrc

TRANSLATIONS += src/qt/locale/wvr_bg.ts \
                src/qt/locale/wvr_de.ts \
                src/qt/locale/wvr_en.ts \
                src/qt/locale/wvr_es.ts \
                src/qt/locale/wvr_fi.ts \
                src/qt/locale/wvr_fr.ts \
                src/qt/locale/wvr_it.ts \
                src/qt/locale/wvr_ja.ts \
                src/qt/locale/wvr_pl.ts \
                src/qt/locale/wvr_pt.ts \
                src/qt/locale/wvr_ru.ts \
                src/qt/locale/wvr_sk.ts \
                src/qt/locale/wvr_sv.ts \
                src/qt/locale/wvr_vi.ts \
                src/qt/locale/wvr_zh_CN.ts \
                src/qt/locale/wvr_zh_TW.ts
