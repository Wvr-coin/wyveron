...
#ifndef wvr_ZwvrTRACKER_H
#define wvr_ZwvrTRACKER_H
...
public:
    CzwvrTracker(std::string strWalletFile);
    ~CzwvrTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzwvrWallet* zwvrWallet = NULL);
