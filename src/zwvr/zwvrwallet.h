// Copyright (c) 2017-2018 The wvr developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef wvr_ZwvrWALLET_H
#define wvr_ZwvrWALLET_H
...
public:
    CzwvrWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZwvr(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZwvr(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
