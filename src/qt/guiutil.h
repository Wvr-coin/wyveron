...
/** Utility functions used by the wvr Qt UI.
 */
namespace GUIUtil
{
...
// Render wvr addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZwvr = false);
...
// Parse "wvr:" URI into recipient object, return true on successful parsing
