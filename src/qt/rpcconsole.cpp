                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzwvrPathCustom = GetArg("-zwvrbackuppath", "");
    ...
    if(!strzwvrPathCustom.empty()) {
        ui->wallet_customzwvrbackuppath->setText(QString::fromStdString(strzwvrPathCustom));
        ui->wallet_customzwvrbackuppath_label->setVisible(true);
        ui->wallet_customzwvrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzwvrPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the wvr RPC console.") + "<br>" +
