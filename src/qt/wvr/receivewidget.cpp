...
#include "qt/wvr/forms/ui_receivewidget.h"
...
#include "qt/wvr/addressholder.h"
...
ReceiveWidget::ReceiveWidget(wvrGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive wvr."));
