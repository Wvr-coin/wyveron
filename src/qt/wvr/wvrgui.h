...
#ifndef wvr_CORE_NEW_GUI_wvrGUI_H
#define wvr_CORE_NEW_GUI_wvrGUI_H
...
#include "qt/wvr/navmenuwidget.h"
#include "qt/wvr/topbar.h"
#include "qt/wvr/dashboardwidget.h"
#include "qt/wvr/send.h"
#include "qt/wvr/receivewidget.h"
#include "qt/wvr/addresseswidget.h"
#include "qt/wvr/privacywidget.h"
#include "qt/wvr/coldstakingwidget.h"
#include "qt/wvr/masternodeswidget.h"
#include "qt/wvr/snackbar.h"
#include "qt/wvr/settings/settingswidget.h"
...
/**
  wvr GUI main class. This class represents the main window of the wvr UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class wvrGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit wvrGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~wvrGUI();
...
#endif //wvr_CORE_NEW_GUI_wvrGUI_H
