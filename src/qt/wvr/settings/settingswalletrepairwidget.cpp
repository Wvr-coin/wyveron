...
#include "qt/wvr/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/wvr/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(wvrGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to wvrGUI::handleRestart()
