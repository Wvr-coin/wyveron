...
#include "qt/wvr/settings/settingsnetworkwidget.h"
#include "qt/wvr/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/wvr/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(wvrGUI* _window, QWidget *parent) :
