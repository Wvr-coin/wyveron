...
#include "qt/wvr/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(wvrGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("Enter a wvr address"));
...
void SettingsBitToolWidget::importAddressFromDecKey(){
    ...
    ui->statusLabel_DEC->setText(tr("Successfully added wvrate key to the wallet"));
}
