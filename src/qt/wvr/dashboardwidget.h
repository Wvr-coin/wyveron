...
#include "config/wvr-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalwvr = 0;
    qint64 totalZwvr = 0;
    QList<qreal> valueswvr;
    QList<qreal> valueszwvr;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(wvrGUI* _window);
    ~DashboardWidget();
