...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, wvrGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, wvrGUI *gui, double posX = 3);
