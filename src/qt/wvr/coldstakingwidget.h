...
#include "qt/wvr/furabstractlistitemdelegate.h"
#include "qt/wvr/txviewholder.h"
#include "qt/wvr/tooltipmenu.h"
#include "qt/wvr/sendmultirow.h"
#include "qt/wvr/coldstakingmodel.h"
#include "qt/wvr/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(wvrGUI* parent);
    ~ColdStakingWidget();
