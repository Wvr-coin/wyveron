...
#include "qt/wvr/coldstakingwidget.h"
#include "qt/wvr/forms/ui_coldstakingwidget.h"
#include "qt/wvr/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/wvr/requestdialog.h"
#include "qt/wvr/tooltipmenu.h"
#include "qt/wvr/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(wvrGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your wvrs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept wvr delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select wvr outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 wvr" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
