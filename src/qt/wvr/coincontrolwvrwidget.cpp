...
#include "qt/wvr/coincontrolwvrwidget.h"
#include "qt/wvr/forms/ui_coincontrolwvrwidget.h"

CoinControlwvrWidget::CoinControlwvrWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlwvrWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select wvr Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("wvr");
    ...
    ui->labelValueAfter->setText("0.00 wvr");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 wvr");
    ui->labelValueFee->setText("0.00 wvr");
...
CoinControlwvrWidget::~CoinControlwvrWidget()
{
    delete ui;
}
