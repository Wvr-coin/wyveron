 ...
 * wvr system. There are three: the main network on which people trade goods
...
public:
    ...
    int wvrBadBlockTime() const { return nwvrBadBlockTime; }
    int wvrBadBlocknBits() const { return nwvrBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nwvrBadBlockTime;
    unsigned int nwvrBadBlocknBits;
