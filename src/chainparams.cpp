...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x000008d552062ffb1b6540833a34f5d1a5d0e5af5138407f8f1454576d375aad"))
	
	
	;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1665050400, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 9092;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // wvr starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nwvrBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nwvrBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1665050400;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 5729561;

        hashGenesisBlock = genesis.GetHash();

 	assert(hashGenesisBlock == uint256("0x000008d552062ffb1b6540833a34f5d1a5d0e5af5138407f8f1454576d375aad"));
        assert(genesis.hashMerkleRoot == uint256("0xeaa35f1ebd7980ed25c88a48953e88779db8268ec322c7c885b8c175bc5862f9"));
    
        vSeeds.push_back(CDNSSeedData("207.180.212.38", "207.180.212.38"));	
	vSeeds.push_back(CDNSSeedData("62.171.160.49", "62.171.160.49"));	
        vSeeds.push_back(CDNSSeedData("seed1.wyveroncoin.com", "seed1.wyveroncoin.com"));					
        vSeeds.push_back(CDNSSeedData("seed2.wyveroncoin.com", "seed2.wyveroncoin.com"));
        vSeeds.push_back(CDNSSeedData("seed3.wyveroncoin.com", "seed3.wyveroncoin.com"));
        vSeeds.push_back(CDNSSeedData("seed4.wyveroncoin.com", "seed4.wyveroncoin.com"));		
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zwvr to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nwvrBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nwvrBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet wvr addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet wvr script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet wvr BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet wvr BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet wvr BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "wvrfGRkekRyDRNeJiLtYVEbvhXrNbmox";
