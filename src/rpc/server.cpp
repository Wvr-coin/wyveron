...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* wvr features */
        {"wvr", "listmasternodes", &listmasternodes, true, true, false},
        {"wvr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wvr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wvr", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"wvr", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"wvr", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"wvr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wvr", "masternodedebug", &masternodedebug, true, true, false},
        {"wvr", "startmasternode", &startmasternode, true, true, false},
        {"wvr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wvr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wvr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wvr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wvr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wvr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wvr", "preparebudget", &preparebudget, true, true, false},
        {"wvr", "submitbudget", &submitbudget, true, true, false},
        {"wvr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wvr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wvr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wvr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wvr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wvr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wvr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wvr", "checkbudgets", &checkbudgets, true, true, false},
        {"wvr", "mnsync", &mnsync, true, true, false},
        {"wvr", "spork", &spork, true, true, false},
        {"wvr", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> wvr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9091/\n";
}
