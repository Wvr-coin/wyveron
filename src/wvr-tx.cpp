...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("wvr Coin wvr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wvr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wvr transaction") + "\n" +
                               "  wvr-tx [options] -create [commands]   " + _("Create hex-encoded wvr transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wvr transaction
